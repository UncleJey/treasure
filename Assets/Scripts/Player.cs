...
public class Player : MonoBehaviour
{
    ...
    public Vector2 Point
    {
        get
        {
            ...
            return new Vector2((int) ((pos.x + pos.z) / (TheMap.cellSize + TheMap.cellSize)),
                (int) ((pos.y + pos.w) / (TheMap.cellSize + TheMap.cellSize)));
        }
        set
        {
            var sizeDelta = rt.sizeDelta;
            rt.anchoredPosition = new Vector2(value.x * TheMap.cellSize + sizeDelta.x / 2,
                value.y * TheMap.cellSize + sizeDelta.y / 4);
        }
    }
    ...
    public Vector4 Position
    {
        get
        {
            ...
            return new Vector4(rt.anchoredPosition.x - rt.sizeDelta.x / 2 + 10,
                (anchoredPosition = rt.anchoredPosition).y, anchoredPosition.x + rt.sizeDelta.x / 2 - 10,
